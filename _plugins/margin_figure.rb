...
module Jekyll
  class RenderMarginFigureTag < Liquid::Tag
    ...
    def render(context)
      ...
      # if @text[1].start_with?('YOUTUBE:')
      #   "<label for='#{@text[0]}' class='margin-toggle'>&#8853;</label>" +
      #   "<input type='checkbox' id='#{@text[0]}' class='margin-toggle'/>" +
      #   "<span class='marginnote'>" + 
      #   "<figure><iframe class='ytplayer-smallwidth' type='text/html' width='100%' height='100%' src='https://www.youtube.com/embed/#{@text[1][8..]}' frameborder='0'></iframe>" +
      #   "</figure><br/>#{@text[2]}</span>"
      # else
